    ...
    def test_successful_save(self, tmp_path, sample_dfs, sample_logs):
        ...
        with pd.ExcelFile(output_file) as xlsx:
            ...
            pd.testing.assert_frame_equal(
                pd.read_excel(xlsx, "Original Data"), raw_data, check_dtype=False
            )
            pd.testing.assert_frame_equal(
                pd.read_excel(xlsx, "Processed Data"), parsed_data, check_dtype=False
            )
            pd.testing.assert_frame_equal(
                pd.read_excel(xlsx, "Updated Categories"), final_data, check_dtype=False
            )
            pd.testing.assert_frame_equal(
